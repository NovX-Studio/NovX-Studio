  ...
  return (
    <section className="py-10 px-6 bg-bg-base">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Card className="w-full h-[520px] md:h-[620px] bg-bg-card border-black/5 relative overflow-hidden rounded-2xl">
            ...
            <div className="flex h-full">
              ...
              <div className="w-[45%] p-10 md:p-14 relative z-10 flex flex-col justify-center gap-5">
                ...
                <h2 className="font-serif text-4xl md:text-5xl font-normal text-black leading-tight">
                  Interfaces que <em className="text-black/40">sorprenden.</em>
                </h2>
                ...
                <div className="pt-2">
                  <Link href="/contacto">
                    <button className="bg-black hover:bg-black/90 text-white font-semibold text-sm px-7 py-3 rounded-full transition-all duration-200 hover:scale-105">
                      Empezar un proyecto
                    </button>
                  </Link>
                </div>
